...
Function Transpose2dArray(arr As Variant, Optional last_row As Long = 0)
If last_row = 0 Then
    last_row = UBound(arr, 2)
Else: End If

ReDim new_arr(LBound(arr, 2) To last_row, LBound(arr) To UBound(arr))
